...
function IdPSelectUIParms(){
    ...
    this.defaultReturn = 'https://dmponline.dmpdev.dcc.ac.uk/Shibboleth.sso/Login';       // If non null, then the default place to send users who are not
                                     // Approaching via the Discovery Protocol for example
    //this.defaultReturn = "https://example.org/Shibboleth.sso/DS?SAMLDS=1&target=https://example.org/secure";
    this.defaultReturnIDParam = null;
    this.returnWhiteList = [ "^https:\/\/example\.org\/Shibboleth\.sso\/Login.*$" , "^https:\/\/example\.com\/Shibboleth\.sso\/Login.*$", "^https:\/\/dmponline\.dmpdev\.dcc\.ac\.uk\/Shibboleth\.sso\/Login.*$" ];
    this.helpURL = 'https://dmponline.dmpdev.dcc.ac.uk/help';
    ...
    this.myEntityID = 'https://dmponline.dmpdev.dcc.ac.uk/shibboleth';          // If non null then this string must match the string provided in the DS parms
